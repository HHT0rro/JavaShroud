 ...
 * sealing, then converted to [QpPendingNativeSegment] after a final route is
 * reserved.
 */
internal class QpNativeSegmentCandidate private constructor(
    val pageIndex: Int,
    ...
    internal fun copyForBuild(): QpNativeSegmentCandidate {
        requireLive()
        return QpNativeSegmentCandidate(
            pageIndex = pageIndex,
    ...
    companion object {
        ...
        fun create(
            ...
            return QpNativeSegmentCandidate(
                pageIndex = pageIndex,
                targetPageSize = targetPageSize
                    ?: QpPageSizePolicy.DEFAULT.choose(QpResourceKind.NativeChunk, random),
...
internal fun qpNativeSegmentIdentityPageKey(
    logicalIdentity: ByteArray,
    pageIndex: Int,
): String {
