 ...
 */
internal class QpTextRouteCandidateRef private constructor(
...
internal fun interface QpTextRouteAllocator {
    fun allocate(
        candidate: QpTextRouteCandidateRef,
        ordinal: Int,
...
internal class QpTextRoute private constructor(
    private var identityPageKeyValue: String,
    private var logicalBindingPathValue: String,
 ...
 */
internal class QpTextRouteReservation private constructor(
    ...
    fun <T> withRoutesForBuild(block: (List<QpTextRoute>) -> T): T {
    ...
    companion object {
        fun reserve(
            candidateRefs: Iterable<QpTextRouteCandidateRef>,
        ...
        private fun allocatePass(
            ...
            candidates.forEachIndexed { ordinal, candidate ->
                val allocatorCandidate = QpTextRouteCandidateRef.create(
                    identityPageKey = candidate.identityPageKey,
                    logicalBindingPath = candidate.logicalBindingPath,
                )
