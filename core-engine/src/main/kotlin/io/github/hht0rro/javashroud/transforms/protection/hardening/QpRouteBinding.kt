 ...
 */
internal class QpRouteBinding private constructor(
    ...
    fun matches(other: QpRouteBinding): Boolean {
    ...
    private fun digestCanonical(): ByteArray {
        ...
        digest.update(ProtectionFormat.CURRENT_LABEL.toByteArray(Charsets.US_ASCII))
    ...
    companion object {
        private val DOMAIN = "javashroud-qp-route-binding-v1".toByteArray(Charsets.US_ASCII)
