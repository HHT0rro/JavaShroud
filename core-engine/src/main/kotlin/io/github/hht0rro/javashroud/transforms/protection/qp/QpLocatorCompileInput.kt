 ...
 * at page-access time.
 */
internal class QpLocatorCompileInput private constructor(
    val entryToken: Long,
    ...
    internal fun matchesCurrentPageForBuild(
        ...
        if (encodedHandle.size != QpHandle.ENCODED_HANDLE_SIZE || rawCallSiteProof.isEmpty()) return false

        var descriptor: QpPageDescriptor? = null
        ...
        try {
            ...
            envelope = QpPageEnvelope.decode(nativeEnvelopeValue)
    ...
    companion object {
        ...
        fun fromTypedPage(
            ...
            try {
                ...
                routeBytes = route.encode()
                val entryToken = QpPageEntryToken.derive(
                ...
                envelopeBytes = envelope.encode()
                pageBindingDigest = QpPageEntryToken.pageBinding(
                    resourceKind = resolvedDescriptor.resourceKind,
                    pageIndex = resolvedDescriptor.pageIndex,
                    encodedHandle = encodedHandle,
                    routeEncoding = routeBytes,
