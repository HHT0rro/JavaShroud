 ...
 */
internal class QpClassRouteCandidateRef private constructor(
...
internal fun interface QpClassRouteAllocator {
    fun allocate(
        candidate: QpClassRouteCandidateRef,
        ordinal: Int,
...
internal class QpClassRoute private constructor(
    private var identityPageKeyValue: String,
    private var logicalBindingPathValue: String,
 ...
 */
internal class QpClassRouteReservation private constructor(
    ...
    fun <T> withRoutesForBuild(block: (List<QpClassRoute>) -> T): T {
    ...
    companion object {
        fun reserve(
            candidateRefs: Iterable<QpClassRouteCandidateRef>,
        ...
        private fun allocatePass(
            ...
            candidates.forEachIndexed { ordinal, candidate ->
                val allocatorCandidate = QpClassRouteCandidateRef.create(
                    identityPageKey = candidate.identityPageKey,
                    logicalBindingPath = candidate.logicalBindingPath,
                )
