...
internal class QpBoundCore private constructor(
    ...
    internal fun copyPageMaterialForBuild(): ByteArray {
        requireLive()
        return QpBoundPlan.materializePageMaterial(
    ...
    internal fun finalizeForRuntime(
        ...
        try {
            finalBinding = QpBoundPlan.finalBinding(staticBindingValue, routeBytes, callSiteProof)
            encoded = QpBoundPlan.encodeOpaque(
                dialectByte = dialectByteValue,
            ...
            return QpBoundPlan.fromOpaque(checkNotNull(encoded))
        } finally {
    ...
    companion object {
        internal fun compile(
            ...
            var completed = false
            try {
                staticBinding = QpBoundPlan.staticBinding(
                ...
                dialectCommitment = QpBoundPlan.dialectCommitment(
...
internal class QpBoundPlan private constructor(opaque: ByteArray) {
    ...
    override fun equals(other: Any?): Boolean =
        other is QpBoundPlan && Arrays.equals(opaqueValue, other.opaqueValue)

    override fun hashCode(): Int = opaqueValue.contentHashCode()

    override fun toString(): String = "QpBoundPlan(bytes=${opaqueValue.size})"
    ...
    companion object {
        ...
        internal fun fragmentMask(
            ...
            require(offset >= 0 && length > 0 && offset + length <= QpMethodMaterial.PAGE_MATERIAL_SIZE)
