 ...
 */
internal class QpPendingTextPage private constructor(
    ...
    companion object {
        ...
        fun create(
            ...
            val selectedTargetPageSize =
                targetPageSize ?: QpPageSizePolicy.DEFAULT.choose(QpResourceKind.StringPage, random)
            return QpPendingTextPage(
                resourcePath = resourcePath,
                resourceOffset = resourceOffset,
                pageIndex = pageIndex,
