 ...
 */
class QpPageLayout private constructor(
    ...
    fun bodyOffset(): Int {
        ...
        return if (headerAfterBodyValue) {
            ...
            prefixLength + QpPageCodec.LOGICAL_HEADER_SIZE
        }
    }
    ...
    internal fun copyForBuild(): QpPageLayout {
        requireLive()
        return QpPageLayout(
    ...
    companion object {
        ...
        internal fun create(family: String, random: SecureRandom): QpPageLayout {
            ...
            // variant into QpBuildPlan after that commitment is known.  Keep
