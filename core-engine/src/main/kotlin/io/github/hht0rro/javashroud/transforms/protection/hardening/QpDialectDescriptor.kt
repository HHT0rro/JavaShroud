 ...
 */
internal class QpDialectDescriptor private constructor(
    val encode: IntArray,
    val decode: IntArray,
    ...
    companion object {
        ...
        fun fromBuildContext(context: QpBuildContext): QpDialectDescriptor {
            val crypto = io.github.hht0rro.javashroud.transforms.protection.QpInnerMaterial.copyCryptoDomainMaterial(context)
            val layout = io.github.hht0rro.javashroud.transforms.protection.QpInnerMaterial.copyStateBindingLayoutDigest(context)
            try {
        ...
        fun fromKeyMaterial(cryptoDomainMaterial: ByteArray, layoutDigest: ByteArray): QpDialectDescriptor {
