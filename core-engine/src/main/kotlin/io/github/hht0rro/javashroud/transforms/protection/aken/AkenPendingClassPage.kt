 ...
 */
internal class AkenPendingClassPage private constructor(
    ...
    companion object {
        ...
        fun create(
            ...
            val selectedTargetPageSize =
                targetPageSize ?: AkenPageSizePolicy.DEFAULT.choose(AkenResourceKind.EncryptedClassPage, random)
            return AkenPendingClassPage(
                resourcePath = resourcePath,
                resourceOffset = resourceOffset,
                pageIndex = pageIndex,
