 ...
 */
internal class QpMethodCandidate private constructor(
    val entryToken: Long,
    val logicalMethod: QpMethodIdentity,
    ...
    internal fun copyForBuild(): QpMethodCandidate {
        requireLive()
    ...
    companion object {
        ...
        fun create(
            entryToken: Long,
            logicalMethod: QpMethodIdentity,
            logicalIdentity: ByteArray,
            serializedProgram: ByteArray,
