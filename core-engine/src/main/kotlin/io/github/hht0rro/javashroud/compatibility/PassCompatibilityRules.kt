...
fun buildOrderingConstraints(): List<OrderingConstraint> = listOf(
    ...
    OrderingConstraint(before = "environment-bound-keys", after = "string-encryption", reason = "Environment-bound key material should exist before string encryption derives protected constants."),
    OrderingConstraint(before = "environment-bound-keys", after = "field-string-encryption", reason = "Environment-bound key material should exist before field string encryption."),
    OrderingConstraint(before = "environment-bound-keys", after = "method-body-delayed-decryption", reason = "Environment-bound key material should exist before method body delayed decryption."),
