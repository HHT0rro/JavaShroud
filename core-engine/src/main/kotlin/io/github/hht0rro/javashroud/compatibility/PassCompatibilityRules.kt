...
fun buildOrderingConstraints(): List<OrderingConstraint> = listOf(
    ...
    OrderingConstraint(before = "jni-microkernel-loader", after = "callsite-rotation-protection", reason = "JNI kernel must load before callsite rotation inserts invokedynamic wrappers so bootstrap classes still receive loadKernel."),
