...
fun buildOrderingConstraints(): List<OrderingConstraint> = listOf(
    OrderingConstraint(before = "rename-classes", after = "method-virtualization", reason = "Class renaming must complete before native VM captures owner references."),
    OrderingConstraint(before = "rename-packages", after = "method-virtualization", reason = "Package renaming must complete before native VM captures owner references."),
    OrderingConstraint(before = "rename-methods", after = "method-virtualization", reason = "Method renaming must complete before native VM lowers selected method bodies."),
    OrderingConstraint(before = "rename-fields", after = "method-virtualization", reason = "Field renaming must complete before native VM captures field references."),
    ...
    OrderingConstraint(before = "method-virtualization", after = "string-encryption", reason = "native VM must capture selected methods before StringPage callsites are introduced."),
    OrderingConstraint(before = "integer-constant-obfuscation", after = "method-virtualization", reason = "Integer rewriting must complete before native VM captures arithmetic."),
    OrderingConstraint(before = "static-init-perturbation", after = "method-virtualization", reason = "Static initialization changes must complete before native VM lowering."),
    OrderingConstraint(before = "anti-decompiler-structure", after = "method-virtualization", reason = "Anti-decompiler bytecode must be captured before native VM lowering."),
    OrderingConstraint(before = "method-virtualization", after = "invoke-dynamic-indirection", reason = "native VM must capture selected methods before InvokeDynamic indirection introduces helper callsites."),
    OrderingConstraint(before = "control-flow-obfuscation", after = "method-virtualization", reason = "Control-flow rewriting must complete before native VM lowering."),
    OrderingConstraint(before = "reference-proxy", after = "method-virtualization", reason = "Reference-proxy rewriting must complete before native VM lowering."),
    OrderingConstraint(before = "control-flow-flattening", after = "method-virtualization", reason = "Flattened control flow must complete before native VM lowering."),
    OrderingConstraint(before = "condy-constant-indirection", after = "method-virtualization", reason = "ConstantDynamic indirection must complete before native VM lowering."),
    ...
    OrderingConstraint(before = "method-virtualization", after = "callsite-rotation-protection", reason = "native VM must capture selected methods before callsite rotation introduces Java helper invokedynamic sites."),
    ...
    OrderingConstraint(before = "method-virtualization", after = "jni-microkernel-loader", reason = "native VM pages must exist before current native runtime sealing."),
    OrderingConstraint(before = "method-virtualization", after = "os-anti-debug", reason = "native VM lowering completes before unified defense probes are injected."),
