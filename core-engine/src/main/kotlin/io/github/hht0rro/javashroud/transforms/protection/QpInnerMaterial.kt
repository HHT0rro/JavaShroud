 ...
 */
internal object QpInnerMaterial {
    ...
    fun copyCryptoDomainMaterial(context: QpBuildContext): ByteArray {
    ...
    fun copyStateBindingLayoutDigest(context: QpBuildContext): ByteArray {
    ...
    fun copyStateBindingLayoutDigest(): ByteArray =
        copyStateBindingLayoutDigest(requireQpBuildContext())

    fun deriveVmBuildKey(context: QpBuildContext): ByteArray {
