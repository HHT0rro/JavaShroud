...
object QpResourceCodec {
    ...
    fun encode(
        ...
        compress = compress,
        partitions = requireQpBuildContext().runtimeKeyPartitions,
    ...
    internal fun encodeForPartition(
        ...
        val partitions = requireQpBuildContext().runtimeKeyPartitions
    ...
    fun decode(bytes: ByteArray): ByteArray? {
        ...
        return decodePartitioned(bytes, requireQpBuildContext().runtimeKeyPartitions)
    }
    ...
    private fun encodePartitioned(
        ...
        val compressedCandidate = if (compress) QpCompressionCodec.compress(bytes) else bytes
    ...
    internal fun decodePartitioned(bytes: ByteArray, partitions: RuntimeKeyPartitions): ByteArray? {
        ...
        return try {
            ...
            val plain = if (metadata.compressed) QpCompressionCodec.decompress(stored, metadata.plainLength) else stored
