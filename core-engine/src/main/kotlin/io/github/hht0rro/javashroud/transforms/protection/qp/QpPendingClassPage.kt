...
/**
 * Build-only ownership record for one encrypted class byte page whose generated
 ...
 */
internal class QpPendingClassPage private constructor(
    ...
    companion object {
        ...
        /**
         * Reserves one ClassPage frame. A pre-reserved complete layout variant
        ...
        fun create(
            ...
            val selectedVariant = try {
                layoutVariant ?: QpPageLayout.create("class", random).also { generatedLayout = it }.variant
            } finally {
                generatedLayout?.wipe()
            }
            val selectedTargetPageSize =
                targetPageSize ?: QpPageSizePolicy.DEFAULT.choose(QpResourceKind.EncryptedClassPage, random)
            return QpPendingClassPage(
                resourcePath = resourcePath,
                resourceOffset = resourceOffset,
                pageIndex = pageIndex,
