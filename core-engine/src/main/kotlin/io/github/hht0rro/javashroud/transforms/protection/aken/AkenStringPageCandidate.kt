 ...
 * sealing, then converted to [AkenPendingStringPage] after a final route is
 * reserved.
 */
internal class AkenStringPageCandidate private constructor(
    val pageIndex: Int,
    ...
    internal fun copyForBuild(): AkenStringPageCandidate {
        requireLive()
        return AkenStringPageCandidate(
            pageIndex = pageIndex,
     ...
     */
    internal fun toPendingPage(route: AkenStringPagePreSealRoute): AkenPendingStringPage {
        requireLive()
    ...
    companion object {
        ...
        fun create(
            ...
            return AkenStringPageCandidate(
                pageIndex = pageIndex,
                targetPageSize = targetPageSize
                    ?: AkenPageSizePolicy.DEFAULT.choose(AkenResourceKind.StringPage, random),
...
internal fun akenStringPageIdentityPageKey(
    logicalIdentity: ByteArray,
    pageIndex: Int,
): String {
    ...
    val digest = MessageDigest.getInstance("SHA-256").apply {
        ...
        update(AkenResourceKind.StringPage.id.toByte())
