 ...
 */
internal class AkenPendingNativeChunk private constructor(
    ...
    companion object {
        ...
        fun create(
            ...
            val selectedTargetPageSize =
                targetPageSize ?: AkenPageSizePolicy.DEFAULT.choose(AkenResourceKind.NativeChunk, random)
            return AkenPendingNativeChunk(
                resourcePath = resourcePath,
                resourceOffset = resourceOffset,
                pageIndex = pageIndex,
