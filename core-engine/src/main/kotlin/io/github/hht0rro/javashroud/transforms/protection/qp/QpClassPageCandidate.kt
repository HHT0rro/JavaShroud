 ...
 * sealing, then converted to [QpPendingClassPage] after a final route is
 * reserved.
 */
internal class QpClassPageCandidate private constructor(
    val pageIndex: Int,
    ...
    internal fun copyForBuild(): QpClassPageCandidate {
        requireLive()
        return QpClassPageCandidate(
            pageIndex = pageIndex,
    ...
    companion object {
        ...
        fun create(
            ...
            return QpClassPageCandidate(
                pageIndex = pageIndex,
                targetPageSize = targetPageSize
                    ?: QpPageSizePolicy.DEFAULT.choose(QpResourceKind.EncryptedClassPage, random),
...
internal fun qpClassPageIdentityPageKey(
    logicalIdentity: ByteArray,
    pageIndex: Int,
): String {
