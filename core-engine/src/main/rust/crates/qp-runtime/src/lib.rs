...
pub use qp_shell::SupportedTarget;
pub use lifecycle::{
...
use qp_crypto::{Binding, BindingError, Digest, RuntimeBindingDigest};
use qp_page::{EnvelopeFrame, ProtocolError, RuntimeEnvelope};
use qp_shell::{validate_artifact, LoadedArtifact, LoaderError, PlatformError};
use std::fmt;
...
mod tests {
    ...
    use qp_shell::{SupportedTarget, LINUX_X64_GNU_217};
