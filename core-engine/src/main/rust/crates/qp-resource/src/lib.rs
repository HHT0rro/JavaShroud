...
const DIRECTORY_AUTH_DOMAIN: &[u8] = b"JavaShroud/QP/ResourceDirectory/v2";
const FRAME_AUTH_DOMAIN: &[u8] = b"JavaShroud/QP/ResourceFrame/v2";
...
mod tests {
    ...
    fn key(index: i32) -> PageKey {
        PageKey::new(PageKind::QpMethod, index, &[index as u8; 24], &[0xA5; 16])
