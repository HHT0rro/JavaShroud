...
class AkenPendingStringPageTest {
    @Test
    fun pending_string_page_preserves_its_preassigned_handle_proof_frame_and_route_through_materialization() {
        ...
        val resourcePath = "META-INF/.aken/string/pending-fixture.bin"
        ...
        try {
            pending = AkenPendingStringPage.create(
            ...
            val other = try {
                AkenPendingStringPage.create(
                    ...
                    resourcePath = "META-INF/.aken/string/pending-fixture-other.bin",
                    pageIndex = 2,
        ...
        try {
            assertFailsWith<IllegalArgumentException> {
                AkenPendingStringPage.create(
                    ...
                    resourcePath = "META-INF/.aken/string/invalid.bin",
                    pageIndex = 0,
