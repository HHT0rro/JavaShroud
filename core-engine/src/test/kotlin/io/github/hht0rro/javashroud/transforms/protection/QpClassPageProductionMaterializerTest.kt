...
class QpClassPageProductionMaterializerTest {
    @Test
    fun string_page_only_candidates_materialize_before_native_compilation() {
        ...
        try {
            withQpBuildContext(context) {
                ...
                val descriptorPath =
                    QpClassPageDescriptor.resourcePathForInternalNameForBuild(
                ...
                try {
                    descriptor = QpClassPageDescriptor.decodeForBuild(descriptorBytes)
                ...
                scoped.withQpClassPageDescriptorSourcesForBuild { sources ->
