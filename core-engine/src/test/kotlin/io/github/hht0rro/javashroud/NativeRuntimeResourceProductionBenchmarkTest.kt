...
class NativeRuntimeResourceProductionBenchmarkTest {
    ...
    fun rust_native_resource_cache_page_and_lifecycle_contracts_are_bounded_authenticated_and_wiped() {
        ...
        assertContains(resourceManifest, "ruzstd.workspace = true", "qp-resource manifest")
        ...
        assertContains(pageManifest, "unsafe_code = \"forbid\"", "qp-page manifest")
        assertContains(runtimeManifest, "name = \"qp-runtime\"", "qp-runtime manifest")
        assertNoUnsafe(resource, "qp-resource")
        assertNoUnsafe(page, "qp-page")
