...
class QpVmDispatcherGenerationTest {
            ...
            override fun visitMethod(
                ...
                return object : MethodVisitor(Opcodes.ASM9) {
                    ...
                    override fun visitMethodInsn(
                        ...
                        if (opcode != Opcodes.INVOKESTATIC || !owner.endsWith("QpBridge")) return
                        if (
                            methodName == "executeQpVmPage" &&
                            methodDescriptor == "(J[BI[B[Ljava/lang/Object;)Ljava/lang/Object;"
                        ) {
                            typedQpInvocation = true
                        }
    ...
    private fun generatedQpDispatcher(): ByteArray {
        val writer = ClassWriter(ClassWriter.COMPUTE_FRAMES or ClassWriter.COMPUTE_MAXS)
        writer.visit(
            Opcodes.V17,
            Opcodes.ACC_PUBLIC or Opcodes.ACC_SUPER,
            "fixture/QpVmDispatcher",
            null,
            "java/lang/Object",
            null,
        )
        ...
        generateVmDispatcher(
            mv = method,
            className = "fixture/QpVmDispatcher",
            methodName = "invoke",
            descriptor = "(I)I",
