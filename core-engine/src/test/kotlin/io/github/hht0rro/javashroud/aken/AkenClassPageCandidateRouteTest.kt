...
class AkenClassPageCandidateRouteTest {
    @Test
    fun candidate_defensively_owns_class_page_inputs_and_binds_only_a_matching_preseal_route() {
        ...
        var candidateCopy: AkenClassPageCandidate? = null
        var route: AkenClassPagePreSealRoute? = null
        ...
        try {
            ...
            route = AkenClassPagePreSealRoute.create(
                identityPageKey = candidate.identityPageKeyForBuild(),
                logicalBindingPath = bindingPath,
                futureResourcePath = "META-INF/.aken/class/candidate-final.bin",
            )
            ...
            val mismatchedRoute = AkenClassPagePreSealRoute.create(
                identityPageKey = candidate.identityPageKeyForBuild(),
                logicalBindingPath = "META-INF/.logical/class/other.bin",
                futureResourcePath = "META-INF/.aken/class/other-final.bin",
            )
            try {
    ...
    fun preseal_route_reservation_is_scoped_deterministic_and_collision_checked() {
        val later = AkenClassPageRouteCandidateRef.create(
            identityPageKey = "page_z",
            logicalBindingPath = "META-INF/.logical/class/z.bin",
        )
        val earlier = AkenClassPageRouteCandidateRef.create(
        ...
        try {
            reservation = AkenClassPagePreSealRouteReservation.reserve(
                ...
                allocator = AkenClassPagePreSealRouteAllocator { candidate, ordinal, reservedEntryPaths ->
                    ...
                    "META-INF/.aken/class/reserved-$ordinal.bin"
                },
            )
            ...
            reservation.withRoutesForBuild { routes ->
                ...
                assertEquals(
                    listOf(
                        "META-INF/.aken/class/reserved-0.bin",
                        "META-INF/.aken/class/reserved-1.bin",
                    ),
            ...
            val collision = AkenClassPageRouteCandidateRef.create(
            ...
            try {
                assertFailsWith<IllegalArgumentException> {
                    AkenClassPagePreSealRouteReservation.reserve(
                        ...
                        allocator = AkenClassPagePreSealRouteAllocator { _, _, _ -> "META-INF/occupied.bin" },
                    )
                }
            } finally {
                collision.wipe()
            ...
            val duplicate = AkenClassPageRouteCandidateRef.create(
                identityPageKey = "page_a",
            ...
            try {
                assertFailsWith<IllegalArgumentException> {
                    AkenClassPagePreSealRouteReservation.reserve(
                        ...
                        allocator = AkenClassPagePreSealRouteAllocator { _, ordinal, _ ->
                            "META-INF/.aken/class/duplicate-$ordinal.bin"
                        },
                    )
                }
            } finally {
