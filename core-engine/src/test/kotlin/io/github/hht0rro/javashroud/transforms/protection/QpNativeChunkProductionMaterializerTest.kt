...
class QpNativeChunkProductionMaterializerTest {
    @Test
    fun native_chunk_only_candidates_materialize_before_native_compilation() {
        ...
        val candidate = QpNativeSegmentCandidate.create(
        ...
        try {
            withQpBuildContext(context) {
                ...
                scoped.registerQpNativeSegmentCandidates(listOf(candidate))
                candidate.wipe()
                ...
                assertTrue(
                    RuntimeArtifactSealing.reserveQpNativeRoutesIfNeeded(
                        artifact = input,
                ...
                val routePath = buildList {
                    scoped.requireQpNativeRouteReservation().withRoutesForBuild { routes ->
                ...
                val retainedHandle = scoped.withQpNativeSegmentCandidatesForBuild { candidates ->
