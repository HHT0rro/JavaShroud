...
class QpPendingClassPageTest {
    ...
    fun pending_class_page_preserves_its_preassigned_handle_proof_frame_and_route_through_materialization() {
        ...
        val resourcePath = "META-INF/.qp/class/pending-fixture.bin"
        ...
        try {
            pending = QpPendingClassPage.create(
            ...
            try {
                assertEquals(QpResourceKind.EncryptedClassPage, descriptor.resourceKind)
            ...
            val other = try {
                QpPendingClassPage.create(
                    ...
                    resourcePath = "META-INF/.qp/class/pending-fixture-other.bin",
                    pageIndex = 2,
        ...
        try {
            assertFailsWith<IllegalArgumentException> {
                QpPendingClassPage.create(
                    ...
                    resourcePath = "META-INF/.qp/class/invalid.bin",
                    pageIndex = 0,
